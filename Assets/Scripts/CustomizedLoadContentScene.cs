...
namespace Microsoft.MixedReality.Toolkit.Extensions.SceneTransitions
{
    ...
    public class CustomizedLoadContentScene : MonoBehaviour
    {
        [SerializeField]
        private LoadSceneMode loadSceneMode = LoadSceneMode.Single;
        [SerializeField]
        private SceneInfo UnloadScene = SceneInfo.Empty;
        [SerializeField]
        ...
        private void Start()
        {
            if (loadOnStartup)
            {
                UnloadCurrentSceneAndLoadNewScene();
            }
        }
        ...
        /// </summary>
        public void UnloadCurrentSceneAndLoadNewScene()
        {
            using (LoadContentPerfMarker.Auto())
            {
                ...
                transitions.DoSceneTransition(() => CoreServices.SceneSystem.UnloadContent(UnloadScene.Name));
